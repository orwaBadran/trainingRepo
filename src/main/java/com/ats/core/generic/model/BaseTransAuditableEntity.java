...
@MappedSuperclass
public abstract class BaseTransAuditableEntity extends BaseTransEntity {
	...
	protected void populateAudit() {
		...
		// setCreatedBy(SecurityUtil.getCurrentUserRid());
		// } else {
		// setUpdatedDate(new Date());
		// setUpdatedBy(SecurityUtil.getCurrentUserRid());
		// }
	}
